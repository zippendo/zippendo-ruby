...
# Unit tests for Zippendo::CreateShipment201ResponseShippingRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zippendo::CreateShipment201ResponseShippingRule do
  #let(:instance) { Zippendo::CreateShipment201ResponseShippingRule.new }

  describe 'test an instance of CreateShipment201ResponseShippingRule' do
    it 'should create an instance of CreateShipment201ResponseShippingRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Zippendo::CreateShipment201ResponseShippingRule)
    end
  end
