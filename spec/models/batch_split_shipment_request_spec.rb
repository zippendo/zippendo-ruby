...
# Unit tests for Zippendo::BatchSplitShipmentRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zippendo::BatchSplitShipmentRequest do
  #let(:instance) { Zippendo::BatchSplitShipmentRequest.new }

  describe 'test an instance of BatchSplitShipmentRequest' do
    it 'should create an instance of BatchSplitShipmentRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Zippendo::BatchSplitShipmentRequest)
    end
  end
