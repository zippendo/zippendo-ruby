...
# Unit tests for Zippendo::CreateShippingRuleRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zippendo::CreateShippingRuleRequest do
  #let(:instance) { Zippendo::CreateShippingRuleRequest.new }

  describe 'test an instance of CreateShippingRuleRequest' do
    it 'should create an instance of CreateShippingRuleRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Zippendo::CreateShippingRuleRequest)
    end
  end
