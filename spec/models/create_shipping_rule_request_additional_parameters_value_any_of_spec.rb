...
# Unit tests for Zippendo::CreateShippingRuleRequestAdditionalParametersValueAnyOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zippendo::CreateShippingRuleRequestAdditionalParametersValueAnyOf do
  #let(:instance) { Zippendo::CreateShippingRuleRequestAdditionalParametersValueAnyOf.new }

  describe 'test an instance of CreateShippingRuleRequestAdditionalParametersValueAnyOf' do
    it 'should create an instance of CreateShippingRuleRequestAdditionalParametersValueAnyOf' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Zippendo::CreateShippingRuleRequestAdditionalParametersValueAnyOf)
    end
  end
