...
# Unit tests for Zippendo::CheckBrandSlug200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zippendo::CheckBrandSlug200Response do
  #let(:instance) { Zippendo::CheckBrandSlug200Response.new }

  describe 'test an instance of CheckBrandSlug200Response' do
    it 'should create an instance of CheckBrandSlug200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Zippendo::CheckBrandSlug200Response)
    end
  end
