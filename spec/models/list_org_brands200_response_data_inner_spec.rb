...
# Unit tests for Zippendo::ListOrgBrands200ResponseDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zippendo::ListOrgBrands200ResponseDataInner do
  #let(:instance) { Zippendo::ListOrgBrands200ResponseDataInner.new }

  describe 'test an instance of ListOrgBrands200ResponseDataInner' do
    it 'should create an instance of ListOrgBrands200ResponseDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Zippendo::ListOrgBrands200ResponseDataInner)
    end
  end
  ...
  describe 'test attribute "use_org_customs"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
