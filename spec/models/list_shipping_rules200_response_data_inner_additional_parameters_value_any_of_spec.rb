...
# Unit tests for Zippendo::ListShippingRules200ResponseDataInnerAdditionalParametersValueAnyOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zippendo::ListShippingRules200ResponseDataInnerAdditionalParametersValueAnyOf do
  #let(:instance) { Zippendo::ListShippingRules200ResponseDataInnerAdditionalParametersValueAnyOf.new }

  describe 'test an instance of ListShippingRules200ResponseDataInnerAdditionalParametersValueAnyOf' do
    it 'should create an instance of ListShippingRules200ResponseDataInnerAdditionalParametersValueAnyOf' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Zippendo::ListShippingRules200ResponseDataInnerAdditionalParametersValueAnyOf)
    end
  end
