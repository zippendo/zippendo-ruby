...
# Unit tests for Zippendo::CreateOrderRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zippendo::CreateOrderRequest do
  #let(:instance) { Zippendo::CreateOrderRequest.new }

  describe 'test an instance of CreateOrderRequest' do
    it 'should create an instance of CreateOrderRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Zippendo::CreateOrderRequest)
    end
  end
