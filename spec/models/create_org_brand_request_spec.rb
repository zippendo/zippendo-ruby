...
# Unit tests for Zippendo::CreateOrgBrandRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zippendo::CreateOrgBrandRequest do
  #let(:instance) { Zippendo::CreateOrgBrandRequest.new }

  describe 'test an instance of CreateOrgBrandRequest' do
    it 'should create an instance of CreateOrgBrandRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Zippendo::CreateOrgBrandRequest)
    end
  end
