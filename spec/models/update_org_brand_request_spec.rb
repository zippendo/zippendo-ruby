...
# Unit tests for Zippendo::UpdateOrgBrandRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zippendo::UpdateOrgBrandRequest do
  #let(:instance) { Zippendo::UpdateOrgBrandRequest.new }

  describe 'test an instance of UpdateOrgBrandRequest' do
    it 'should create an instance of UpdateOrgBrandRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Zippendo::UpdateOrgBrandRequest)
    end
  end
