...
# Unit tests for Zippendo::ListOrgBrands200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zippendo::ListOrgBrands200Response do
  #let(:instance) { Zippendo::ListOrgBrands200Response.new }

  describe 'test an instance of ListOrgBrands200Response' do
    it 'should create an instance of ListOrgBrands200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Zippendo::ListOrgBrands200Response)
    end
  end
