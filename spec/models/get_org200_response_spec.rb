...
# Unit tests for Zippendo::GetOrg200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zippendo::GetOrg200Response do
  #let(:instance) { Zippendo::GetOrg200Response.new }

  describe 'test an instance of GetOrg200Response' do
    it 'should create an instance of GetOrg200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Zippendo::GetOrg200Response)
    end
  end
