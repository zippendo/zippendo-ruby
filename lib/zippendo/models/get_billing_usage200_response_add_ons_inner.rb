...
module Zippendo
  class GetBillingUsage200ResponseAddOnsInner < ApiModelBase
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["extra_carrier", "extra_channel", "zippy"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["extra_carrier", "extra_channel", "zippy"])
